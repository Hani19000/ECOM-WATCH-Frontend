...
/**
 * Composant affiché lorsque le panier de l'utilisateur ne contient aucun article.
 * Propose un appel à l'action pour retourner vers le catalogue.
 */
export const CartDrawerEmpty = ({ onClose }) => {
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 bg-white">
            ...
            <p className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-600 mb-3 text-center">
