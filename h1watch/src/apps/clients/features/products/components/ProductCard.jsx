                        ...
                        {state.availableColors.map(color => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative w-3 h-3 sm:w-3.5 sm:h-3.5 rounded-full transition-all duration-300
                ...
                <div className="flex items-center justify-between gap-4 pt-2 mt-auto">
                    ...
                    <button
                        ...
                        className={`grow max-w-35 py-3 px-5 rounded-full text-[9px] uppercase tracking-[0.2em] font-bold transition-colors duration-300
                            ${state.isCurrentVariantOut ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-black text-white hover:bg-[#ADA996] shadow-lg active:scale-95"}`}
                    >
